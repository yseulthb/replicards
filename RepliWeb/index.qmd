...
![Fig. 2 - Example of a pattern that can be encoded in a *replicard*. On the left, the picture of the physical replicard; on the right, the corresponding schematic representation.](images/random_replicard_pattern.jpg){width=50%}
...
![Fig. 3 - These three *replicards* encode for the same pattern.](images/PatternTrio.png){width=50%}
...
![Fig. 4 - The initial replicards provided to the students (generation 0) all belong to three types shown here: patterns A, B and C.](images/Patterns_A_B_C.jpg){width=50%}
...
![Fig. 7 - Phylogenetic tree of the *mutant* replicards.](images/phylogenetic_tree_replicards.jpg){width=50%}
